...
| File | What it is |
|---|---|
| [Download AIbleton-0.9.14.ablx](https://github.com/freddyzhangxu/aibleton/releases/download/v0.9.14/AIbleton-0.9.14.ablx) | The Live extension — **required**. Install it from **Live → Settings → Extensions**. |
