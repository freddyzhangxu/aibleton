...
**Current version: v0.9.5** (pre-release) — get it from the
[**Releases page**](https://github.com/freddyzhangxu/aibleton/releases):

| File | What it is |
|---|---|
| [AIbleton-0.9.5.ablx](https://github.com/freddyzhangxu/aibleton/releases/download/v0.9.5/AIbleton-0.9.5.ablx) | The Live extension — **required**. Drop it onto Live's **Settings → Extensions** page. |
| [AIbletonBar-0.9.5-macOS.zip](https://github.com/freddyzhangxu/aibleton/releases/download/v0.9.5/AIbletonBar-0.9.5-macOS.zip) | Optional macOS floating sidebar app (version kept in sync with the extension). |
| [AIbletonBar-0.9.5-Windows.zip](https://github.com/freddyzhangxu/aibleton/releases/download/v0.9.5/AIbletonBar-0.9.5-Windows.zip) | Optional Windows floating sidebar app — toggle with Win+Alt+A (version kept in sync with the extension). |
...
[AIbleton-0.9.5.ablx](https://github.com/freddyzhangxu/aibleton/releases/download/v0.9.5/AIbleton-0.9.5.ablx),
