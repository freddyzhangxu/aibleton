...
| File | What it is |
|---|---|
| [Download AIbleton-0.9.18.ablx](https://github.com/freddyzhangxu/aibleton/releases/download/v0.9.18/AIbleton-0.9.18.ablx) | The Live extension — **required**. Install it from **Live → Settings → Extensions**. |
