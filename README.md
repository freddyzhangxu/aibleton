...
**Current version: v0.8.7** (pre-release) — get it from the
[**Releases page**](https://github.com/freddyzhangxu/aibleton/releases):

| File | What it is |
|---|---|
| [AIbleton-0.8.7.ablx](https://github.com/freddyzhangxu/aibleton/releases/download/v0.8.7/AIbleton-0.8.7.ablx) | The Live extension — **required**. Drop it onto Live's **Settings → Extensions** page. |
| [AIbletonBar-0.8.7-macOS.zip](https://github.com/freddyzhangxu/aibleton/releases/download/v0.8.7/AIbletonBar-0.8.7-macOS.zip) | Optional macOS floating sidebar app (version kept in sync with the extension). |
| [AIbletonBar-0.8.7-Windows.zip](https://github.com/freddyzhangxu/aibleton/releases/download/v0.8.7/AIbletonBar-0.8.7-Windows.zip) | Optional Windows floating sidebar app — toggle with Win+Alt+A (version kept in sync with the extension). |
...
- **AI audio generation** — renders text prompts into WAVs with Stable Audio and drops
  them straight into your Set: loops onto the arrangement, one-shots into a Simpler.
  Files land in your User Library, ready to reuse and search.
...
[AIbleton-0.8.7.ablx](https://github.com/freddyzhangxu/aibleton/releases/download/v0.8.7/AIbleton-0.8.7.ablx),
