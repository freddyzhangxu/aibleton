...
| [AIbletonBar-0.9.7-macOS.zip](https://github.com/freddyzhangxu/aibleton/releases/download/v0.9.7/AIbletonBar-0.9.7-macOS.zip) | 可选的 macOS 悬浮侧边栏（版本号与扩展保持同步）。 |
| [AIbletonBar-0.9.7-Windows.zip](https://github.com/freddyzhangxu/aibleton/releases/download/v0.9.7/AIbletonBar-0.9.7-Windows.zip) | 可选的 Windows 悬浮侧边栏 —— Win+Alt+A 呼出（版本号与扩展保持同步）。 |
