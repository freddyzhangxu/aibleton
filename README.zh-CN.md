...
| 文件 | 说明 |
|---|---|
| [AIbleton-0.8.9.ablx](https://github.com/freddyzhangxu/aibleton/releases/download/v0.8.9/AIbleton-0.8.9.ablx) | Live 扩展本体 —— **必装**。拖进 Live 的 **设置 → Extensions** 页面即可。 |
| [AIbletonBar-0.8.9-macOS.zip](https://github.com/freddyzhangxu/aibleton/releases/download/v0.8.9/AIbletonBar-0.8.9-macOS.zip) | 可选的 macOS 悬浮侧边栏（版本号与扩展保持同步）。 |
| [AIbletonBar-0.8.9-Windows.zip](https://github.com/freddyzhangxu/aibleton/releases/download/v0.8.9/AIbletonBar-0.8.9-Windows.zip) | 可选的 Windows 悬浮侧边栏 —— Win+Alt+A 呼出（版本号与扩展保持同步）。 |
...
[AIbleton-0.8.9.ablx](https://github.com/freddyzhangxu/aibleton/releases/download/v0.8.9/AIbleton-0.8.9.ablx) 后，
