...
- A pure device/sample replacement that only swaps a named playback device for a sample, and does not alter MIDI, clips, mixer, tempo, key, or arrangement, is an operational configuration task: do NOT call set_goal or set_plan, even when search and verification take several calls. Verify it with get_simpler_sample instead.
