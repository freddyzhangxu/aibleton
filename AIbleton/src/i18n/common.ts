...
const COPY: Record<SupportedLanguage, CommonCopy> = {
  zh: {
    ...
    tooManyToolRounds: "工具调用轮次超过上限（{0}），任务已中止。",
  ...
  en: {
    ...
    tooManyToolRounds: "The tool-call round limit ({0}) was exceeded, so the task was stopped.",
  ...
  de: {
    ...
    tooManyToolRounds: "Das Limit für Werkzeugrunden ({0}) wurde überschritten; die Aufgabe wurde gestoppt.",
  ...
  fr: {
    ...
    tooManyToolRounds: "La limite de tours d'outils ({0}) a été dépassée ; la tâche a été arrêtée.",
  ...
  ja: {
    ...
    tooManyToolRounds: "ツール呼び出し回数の上限（{0}）を超えたため、タスクを停止しました。",
  ...
  es: {
    ...
    tooManyToolRounds: "Se superó el límite de rondas de herramientas ({0}); la tarea se detuvo.",
  ...
  it: {
    ...
    tooManyToolRounds: "È stato superato il limite di cicli degli strumenti ({0}); l'attività è stata interrotta.",
